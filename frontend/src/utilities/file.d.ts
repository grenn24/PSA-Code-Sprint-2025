...
export declare function compressImageFile(file: File, maxSize?: number): Promise<File>;
export declare function compressImageFiles(files: File[], maxSize?: number): Promise<File[]>;
