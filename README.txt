...
-   Interactive communication between mentors and mentees (text and video)
-   Real-time guided activites and AI mood analysis
...
1. Ensure that your machine has the following installed:
    ...
    - npm
    - serve
2. Download the latest executable _Codes_Gren.zip_ from the [releases]("https://github.com/grenn24/PSA-Code-Sprint-2025") page
