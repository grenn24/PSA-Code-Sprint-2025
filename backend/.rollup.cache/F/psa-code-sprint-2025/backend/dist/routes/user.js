...
userRouter.get("/:ID/leadership-potential", getID(), userController.catchErrors(userController.predictLeadershipPotential.bind(userController)));
userRouter.get("/:ID/leadership-review", getID(), userController.catchErrors(userController.submitLeadershipReview.bind(userController)));
