...
declare class WBService {
    ...
    postMessage(conversationId: string, data: {
        content: string;
        timestamp: Date;
    }, onDelta: (chunk: string) => void, userID: string): Promise<import("mongoose").Document<unknown, {}, {
    ...
    postMessageStateless(data: {
        content: string;
        timestamp: Date;
    }, history: WBMessage[] | undefined, onDelta: (chunk: string) => void, userID: string, systemPrompt?: string): Promise<string>;
